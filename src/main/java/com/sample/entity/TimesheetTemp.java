...
/**
 * TimesheetTemp generated by hbm2java
 */
@Entity
@Table(name = "timesheet_temp", catalog = "cqp_prime")
public class TimesheetTemp implements java.io.Serializable {
	...
	public TimesheetTemp() {
	}

	public TimesheetTemp(String ne, String section, String department,
