...
/**
 * TimesheetStore generated by hbm2java
 */
@Entity
@Table(name = "timesheet_store", catalog = "cqp_prime")
public class TimesheetStore implements java.io.Serializable {
	...
	public TimesheetStore(String ne, String section, String department,
